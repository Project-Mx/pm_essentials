...
config.fourheadshots = true
config.anticombatroll = true
config.antidriveby = true -- as driver
config.antispampunch = true
config.antistealthkill = true
config.antiweapondrops = true
config.autowalk = true
config.crouch = true 
config.damages = true -- vehicle damage
config.density = true --- ped density
config.fingerpointing = true
config.fixfall = true
config.haircommand = true
config.milescommand = true
config.recoil = true
-- NEW CODES

config.gunpowder = false  --- gun powder notification
config.givecar = true   --- givecar for admin group
config.fps = true  --- fps menu
config.specialchars = true --- disable special characters into names
config.trafficlights = true ---- invicible traffic lights 
--------- DEBUG ----------
